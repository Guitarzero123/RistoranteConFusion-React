...
class Header extends Component {
    ...
    constructor(props) {
        ...
        //You can do this instead of using an Arrow Function?
                            ...
                            <Nav className="ml-auto" navbar>
                                <NavItem>
                                    <Button outline onClick={this.toggleModal}>
                                        <span className="fa fa-login fa-lg"></span> Login
                                    </Button>
                                </NavItem>
                            </Nav>
                        </Collapse>
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <FormGroup>
                                ...
                                <Input type="password" id="password" name="password" innerRef={(input) => this.pasword = input} />
                            </FormGroup>
                            <FormGroup check>
                                <Label check >
